...
| **Optional Tools** | ts-node, ESLint, Prettier |
...
├── /02-functions/ # Functions, generics, overloading
├── /03-classes/ # Classes, inheritance, access modifiers
├── /04-modules/ # Imports, exports, namespaces
├── /05-async-await/ # Async code, Promises, API simulations
├── /06-utils/ # Utility type examples
└── README.md # This file
...
Copy code
npm install
3️⃣ Run Example Files
Use ts-node to directly run TypeScript files:

bash
Copy code
npx ts-node src/example.ts
Or compile to JavaScript and then run:
...
📘 What I Learned
Through this practice repo, I learned to:

Write type-safe and maintainable code.

Understand interfaces, generics, and classes in depth.

Organize large projects using modules and namespaces.

Use async/await effectively for asynchronous programming.
...
Add ESLint + Prettier setup for consistent formatting.
